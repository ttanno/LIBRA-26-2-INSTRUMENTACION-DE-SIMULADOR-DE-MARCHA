...
| :---- | :---- |
| OG: Diseñar e integrar una plataforma móvil instrumentada con sensores para medir variables cinemáticas y cinéticas en un simulador de marcha, para apoyar la validación experimental de prótesis transtibiales | 10% |
| OE1: Diseño Mecánico — diseñar la plataforma móvil considerando los requerimientos mecánicos y funcionales del simulador | 5% |
| OE2: Sistema Electrónico — seleccionar e integrar sensores y sistema electrónico de adquisición y procesamiento | 10% |
| OE3: Software — desarrollar el software para sincronizar, visualizar, registrar y gestionar los datos del sistema | 5% |
...
| :---- | :---- |
| R1: Plataforma diseñada e integrada al simulador | 0% |
| R2: Sistema de sensores (cinemáticos y cinéticos) operativo | 0% |
| R3: Sistema electrónico de adquisición de datos en tiempo real | 0% |
...
| A5: Entendimiento del simulador existente | OE1 | Revisión de fotos del simulador físico y conversación con un compañero de laboratorio sobre su alcance protésico | Ya existe una estructura base construida y el simulador es transtibial únicamente (informal, pendiente confirmación del asesor) |
