...
8. **Definición de alcance del proyecto y entendimiento del simulador existente.** Qué: se revisaron fotos del simulador físico del laboratorio y se conversó con un compañero de laboratorio para entender su geometría y alcance protésico; también se conversó y definieron ángulos importantes con él, como se muestra en la revisión bibliográfica. Para qué: evitar planificar actividades de diseño mecánico desde cero fuera del alcance real. Resultado: se confirmó que ya existe una estructura mecánica base construida y que el simulador es transtibial únicamente, con nivel de amputación ajustable. Pendiente confirmación formal del asesor.
